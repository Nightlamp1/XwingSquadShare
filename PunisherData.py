...
xpilots=[('Redline',27,1,1),('Deathrain',26,1,1),('Black Eight Sq Pilot',23,1,0),('Cutlass Squadron Pilot',21,1,0)] #list pilots

#(qty, upgrade_type) -- Pilot2Upgrades link
upgrades={'Redline':[(1,9),(2,3),(2,4),(2,7),(1,11)],
          'Deathrain':[(1,9),(2,3),(2,4),(2,7),(1,11)],
          'Black Eight Sq Pilot':[(1,9),(2,3),(2,4),(2,7),(1,11)],
          'Cutlass Squadron Pilot':[(1,9),(2,3),(2,4),(2,7),(1,11)]}
...
upgrade_cards = [('Extra Munitions','Torpedoes',2,1,0),
                 ...
                 ('Enhanced Scopes', 'System',1,1,0),
                 ('Twin Ion Engine Mk II', 'Modification',1,2,0)]
