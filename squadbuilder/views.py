...
def squadbuilder(request):
    ...
    '''
        return render_to_response('squadbuilder/builder.html',{'test':'this is working for sure'}, context_instance = RequestContext(request))
            
    else:
        return render(request, 'squadbuilder/builder.html',{'expansions':exps})
